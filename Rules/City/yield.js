...
const getRules = (ruleRegistry = RuleRegistry_1.instance, cityGrowthRegistry = CityGrowthRegistry_1.instance, cityImprovementRegistry = CityImprovementRegistry_1.instance, playerResearchRegistry = PlayerResearchRegistry_1.instance) => [
    ...
    new Yield_1.default(new Priorities_1.Low(), new Criterion_1.default((cityYield) => cityYield instanceof Yields_3.Production), new Criterion_1.default((cityYield, city, yields) => ruleRegistry
    ...
    new Yield_1.default(new Priorities_1.Low(), new Criterion_1.default((cityYield) => cityYield instanceof Yields_1.Gold || cityYield instanceof Yields_2.Research), new Criterion_1.default((cityYield, city, yields) => ruleRegistry
        .get(CivilDisorder_1.CivilDisorder)
        .some((rule) => rule.validate(city, yields))), new Effect_1.default((cityYield) => cityYield.set(0, CivilDisorder_1.CivilDisorder.name))),
    ...[
        [CityImprovements_1.Temple, 1],
        [CityImprovements_1.Colosseum, 2],
        [CityImprovements_1.Cathedral, 3],
